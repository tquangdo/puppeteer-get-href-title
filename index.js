// !!!!!!!! CHU Y!!!
// 1. KO chay duoc alert()
// 2. KO duoc tao file const.js
...
(async () => {
    try {
        ...
        // await page.goto('https://www.easycompare.co.th/quote-form?formID=HP-CMB-TH')
        ...
        // }
        // ~~~~~~~~~~ URL2 END
        // ~~~~~~~~~~ URL3 START: 1) ~ 4)(default) options
        ...
        //         })
        //     })
        //     return arrTieude // => xuat ra console: "Tàu metro đầu tiên cập bến TP.HCM vào ngày 10/10 tới"
        // })
        // const promises = [];
